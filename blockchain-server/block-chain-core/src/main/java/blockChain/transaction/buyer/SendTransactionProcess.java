    ...
    public void socketClientStart() throws Exception {
        ...
        while (true) {
            ...
            if (cryptedTransaction.getState().equals("SYN")) { //  demande de transaction
                ...
                // first scenario
                transactionUtils.emitCryptedTransactionOnNode(generateCryptedTransaction(cryptedTransaction, cryptedTransaction.getKey()));
                Thread.sleep(2000); // on wait 10 sec avant pour pas avoir de souci d'asynchrone
                ...
                ConsensusUtils.systemConsensusAckFeedBackTransactionPersisted(InitTransactionDetails.personnalWallet, walletKey, transactionUtils, cryptedTransaction);
